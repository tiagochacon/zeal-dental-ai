...
import { Shield, Brain, Heart, AlertTriangle, Lightbulb, Target, Sparkles, TrendingUp, MessageCircle } from 'lucide-react';
...
export function AdaptiveNegotiationTab({ 
  ...
  const handleGenerateAnalysis = async () => {
    ...
    try {
      await generateNeurovendasMutation.mutateAsync({ consultationId });
  ...
  const scriptPARE = neurovendasAnalysis?.scriptPARE ? {
    ...
    problem: 'Gere a análise de Neurovendas para ver o script PARE personalizado.',
    agitation: '',
    resolution: '',
    emotion: '',
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
          ...
          >
            ...
            <div className="mt-4">
              ...
              <ul className="space-y-1">
                {patientProfile.primaryTraits.map((trait, i) => (
        ...
        <div className="space-y-6">
            ...
            {neurovendasAnalysis ? (
              ...
              <div className="text-center py-6">
                <p className="text-gray-500 text-sm mb-4">
                  Gere a análise de Neurovendas para mapear objeções
                </p>
                <Button
          ...
          >
            ...
            {neurovendasAnalysis?.scriptPARE ? (
              <ScriptPARE script={scriptPARE} />
            ) : (
              <div className="text-center py-8 text-gray-500">
                <Lightbulb className="w-8 h-8 mx-auto mb-2 opacity-50" />
                <p className="text-sm">Gere a análise de Neurovendas para ver o script PARE personalizado</p>
              </div>
            )}
          </motion.div>
        </div>
