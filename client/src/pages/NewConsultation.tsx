                    ...
                    return (
                      <div className="mt-3 p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg">
                        ...
                        <p className="text-sm text-foreground">
                          Este paciente veio de uma prospecção comercial. Consulte a ficha do paciente para ver o briefing do CRC, o perfil comportamental DISC e o script de vídeo personalizado gerado para ele.
                        </p>
                      </div>
                    );
                  }
